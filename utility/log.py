...
class Log:
    def __init__(self, log_each: int, initial_epoch=-1, save_path= './save'):
    ...
    def flush(self) -> None:
        if self.is_train:
            ...
            self.last_accuracy, self.last_loss = accuracy, loss
            if accuracy > self.best_accuracy:
                self.best_accuracy, self.best_loss = accuracy, loss
